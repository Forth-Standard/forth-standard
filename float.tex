...
\see \place{x:ftrunc}{\xref{float:ops}, \wref{floating:FROUND}{} and
...
\see \xref[12.3.2 Floating-point operations]{float:ops}%
	\place{x:ftrunc}{, \wref{floating:FLOOR}{} and \wref{floating:FTRUNC}{}}.
\end{worddef}
...
\see \xref{float:ops}, \wref{floating:FROUND}{} and \wref{floating:FLOOR}{}.
