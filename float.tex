...
\item \stack{d}{} \stack[F]{}{r} or
	...
	\param{r} is the floating-point value which is nearest to \param{d} in
	the sense of ``round to nearest''.
...
\item \stack[F]{r_1}{r_2} or
	...
	\xalso{float:ops}
	\walso{floating:FROUND}
	\walso{floating:FTRUNC}
\end{worddef}
...
\execute[name]
	...
	\walso{facility:+FIELD}
	\walso{facility:BEGIN-STRUCTURE}
	\walso{facility:END-STRUCTURE}
\end{worddef}
...
\enlargethispage{8ex}\vspace*{-1ex}
...
\note Rounding the floating-point value prior to calling \word{FtoS} is
	...
	\begin{implement} % I.12.6.1.1471 F>S
...
\item \stack[F]{r_1 r_2}{r_3} or
	...
	shall return a value (approximating) $-\pi$ when \param{r_1} $=$ $-0$E
	...
	\begin{testing} % T.12.6.1.1389 FATAN2
		\ttfamily
...
\item \stack[F]{r_1}{r_2} or \stack{r_1}{r_2}
	...
	\begin{implement} % I.12.6.1.1627 FTRUNC
	...
	\begin{testing} % T.12.6.1.1627 FTRUNC
		\texttt{SET-EXACT}
...
\runtime[\word{TO} \param{name}]
	...
	\begin{implement} % I.12.6.1.1628 FVALUE
		\dffamily
	...
	\begin{testing} % T.12.6.1.1628 FVALUE
		\ttfamily
...
\item \stack{n}{} \stack[F]{}{r} or \stack{n}{r}
	...
	\param{r} is the floating-point value which is nearest to
	\param{n} in the sense of ``round to nearest''.

	\walso{floating:FtoS}

	\begin{implement} % I.12.6.1.2175 S>F
