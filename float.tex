...
\place{ed10b}{\emph{f-addr}} & \uline{float-aligned address} & \uline{1 cell} \\
\place{ed10b}{\emph{sf-addr}} & \uline{single-float-aligned address} & \uline{1 cell} \\
	\hline\hline
	\end{tabular}
  \end{center}
\end{table}
...
\begin{table}[ht]
  \begin{center}
	...
	\begin{tabular}{p{9em}rcp{0.42\textwidth}}
		...
		\hline
		\remove{x:wordset-query}{\texttt{FLOATING}}		& \sout{\emph{flag}}		& \sout{no}	&
			\sout{floating-point word set present} \\
		\remove{x:wordset-query}{\texttt{FLOATING-EXT}}	& \sout{\emph{flag}}		& \sout{no}	&
			\sout{floating-point extensions word set present} \\
...
\see \xref{float:ops}, \wref{floating:FROUND}{}\replace{ed10}{ and}{,}
...
\see \xref[12.3.2 Floating-point operations]{float:ops},
	\wref{floating:FLOOR}{}\replace{ed10}{ and}{,} \wref{floating:FTRUNC}{}.
\end{worddef}
...
\item \stack{}{}\strike{2.5}{35} \stack{n_1 "<spaces>name"}{n_2}\strike{-3}{120}
	...
	\begin{quote}\ttfamily
	\sout{\word{DFALIGNED} 1 \word{DFLOATS} \word[facility]{+FIELD}}
	\end{quote}

	\uline{Skip leading space delimiters. Parse \param{name} delimited by
	a space. \param{Offset} is the first double-float aligned value greater
	than or equal to}
	\param{n_1}\strike{-2.6}{11}.
	\param{n_2 = offset + 1}\strike{-2.6}{60} \uline{double-float.}
...
\execute[name] \stack{a-addr_1}{a-addr_2}\strike{-3}{170}
	...
	\uline{giving the double-float aligned address}
...
\see \wref{facility:+FIELD}{+FIELD},
	...
	\begin{implement} % I.12.6.1.---- DFFIELD
		...
		of size a double-float. The filed is aligned.}}

		\sout{\word{:} DFFIELD:\tab\word{bs} n1 <"name"> -{}- n2 ; Exec: addr -{}- 'addr} \\
		\tab \sout{\word{DFALIGNED} 1 \word{DFLOATS} \word[facility]{+FIELD}} \\
		\sout{\word{;}}
	\end{implement}
\end{worddef*}
...
\item \stack[F]{r_1 r_2}{r_3} or
	...
	A system \replace{ed10b}{which}{that} returns false for ``\texttt{-0E 0E 0E \word{Ftilde}}''
...
\item \stack{}{}\strike{2.5}{35} \stack{n_1 "<spaces>name"}{n_2}\strike{-3}{120}
	...
	\sout{%
		...
		execution semantics of the phrase:}
	\begin{quote}\ttfamily
	\sout{\word{FALIGNED} 1 \word{FLOATS} \word[facility]{+FIELD}}
	\end{quote}
	...
	than or equal to}
	\param{n_1}\strike{-2.6}{11}.
	\param{n_2 = offset + 1}\strike{-2.6}{60} \uline{float.}
...
\execute[name] \stack{a-addr_1}{a-addr_2}\strike{-3}{170}
	...
	to}
	\param{a-addr_1}\strike{-2.6}{34}
	\uline{giving the float aligned address}
	\param{a-addr_2}\strike{-2.6}{34}.
...
\see \wref{facility:+FIELD}{+FIELD},
	...
	\begin{implement} % I.12.6.1.---- FFIELD
		\sout{\textdf{Create a new field within a structure definition
		of size a float. The filed is aligned.}}

		\sout{\word{:} FFIELD:\tab\word{bs} n1 <"name"> -{}- n2 ; Exec: addr -{}- 'addr} \\
		\tab \sout{\word{FALIGNED} 1 \word{FLOATS} \word[facility]{+FIELD}} \\
		\sout{\word{;}}
	\end{implement}
\end{worddef*}
...
\item \stack[F]{r}{\remove{ed10b}{--}} \stack{"<spaces>name"}{} or
	\stack{r "<spaces>name"}{}
...
\item \stack{}{}\strike{2.5}{35} \stack{n_1 "<spaces>name"}{n_2}\strike{-3}{120}
	...
	\sout{%
		...
		execution semantics of the phrase:}
	\begin{quote}\ttfamily
	\sout{\word{SFALIGNED} 1 \word{SFLOATS} \word[facility]{+FIELD}}
	\end{quote}

	\uline{Skip leading space delimiters. Parse \param{name} delimited by
	a space. \param{Offset} is the first single-float aligned value greater
	than or equal to}
	\param{n_1}\strike{-2.6}{11}.
	\param{n_2 = offset + 1}\strike{-2.6}{60} \uline{single-float.}
...
\execute[name] \stack{a-addr_1}{a-addr_2}\strike{-3}{170}
	...
	to}
	\param{a-addr_1}\strike{-2.6}{34}
	\uline{giving the single-float aligned address}
	\param{a-addr_2}\strike{-2.6}{34}.
...
\see \wref{facility:+FIELD}{+FIELD},
	...
	\begin{implement} % I.12.6.1.---- SFFIELD
		\sout{\textdf{Create a new field within a structure definition
		of size a single-float. The filed is aligned.}}

		\sout{\word{:} SFFIELD:\tab\word{bs} n1 <"name"> -{}- n2 ; Exec: addr -{}- 'addr} \\
		\tab \sout{\word{SFALIGNED} 1 \word{SFLOATS} \word[facility]{+FIELD}} \\
		\sout{\word{;}}
	\end{implement}
\end{worddef*}
