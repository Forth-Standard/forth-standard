...
is reported.  For \replace{ed09b}{exmaple}{example}:
...
The test cases in John \replace{ed09b}{Heyes}{Hayes}' original test suite were designed to
...
\emph{\replace{ed09b}{must}{should}} pass all of the
