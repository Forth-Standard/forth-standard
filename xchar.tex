% !TeX root = forth.tex
\chapter[The optional Extended-Character word set]{The optional Extended-Character \replace{ed14}{wordset}{ word set}} % 18
\wordlist{xchar}

\section{Introduction} % 18.1
\label{xchar:intro}

This \replace{ed14}{wordset}{ word set} deals with variable width character encodings.  It also
...
\replace{ed14}{wordset}{ word set} is present.  This includes dictionary definitions\remove{ed14}{, so the
