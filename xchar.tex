...
\subsection[Input and Output]{\uline{Input and Output}} % 18.3.5
\label{xchar:io}

\uline{IO words such as
\word{KEY}, 
\word{EMIT},
\word{TYPE},
\word[file]{READ-FILE},
...
\remove{x:xchar}{Terminal string IO like \word{TYPE} and \word{ACCEPT} also are extended to
