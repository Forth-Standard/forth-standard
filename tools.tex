...
\see \rref{tools:CS-PICK}{}.
	...
	\begin{rationale} % A.15.6.2.1015 CS-PICK
		...
		\begin{quote}\ttfamily\small
			...
			\tab[6]~\word{p} flag -{}- ) \tab[2.2]~\word{bs} Execution \\
...
\begin{worddef}[NAMEtoSTRING]{1909}[40]{NAME>STRING}[name-to-string]
...
\begin{worddef}{2534}{[UNDEFINED]}[bracket-undefined]
\compile
	Perform the execution semantics given below.
