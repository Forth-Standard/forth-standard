...
%	\ftest{<pre>}{<post>}{<type>}	A Floating-Point test
...
% As part of the testing environment we also provide the \test and
% \ftest macros to typeset the text of a test case.

% \test{test code}{expected results}
\newcommand{\test}{\forth@test{\forth@test@cell}}
\newcommand{\ftest}{\forth@test{\forth@test@float}}
\newcommand{\forth@test}[1]{\frenchspacing\obeyspaces#1}
\newcommand{\forth@test@cell}[2]{%
	\texttt{T\{ #1 -> #2 \}T}%
	\nonfrenchspacing\catcode`\ =10}
\newcommand{\forth@test@float}[3]{%
	\texttt{T\{ #1 -> #2 #3\}T}%
	\nonfrenchspacing\catcode`\ =10}
