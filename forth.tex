...
% I don't like this but it seams that \@ifnextchar is serverly
% limited in what it can do.  Spliting the command into three
% is the only way I have found to do this.
