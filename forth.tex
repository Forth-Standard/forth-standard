...
\newcommand{\revision}{07.2}	% Document Revision
...
\usepackage{multicol}	% Multiple Columns (for throw code table)
...
\accept{x:ekeys,x:defined,x:required,x:foreword,x:to,test}
% \reject{X:fp-stack}
