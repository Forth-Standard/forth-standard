...
\see \xref[3.4 The Forth text interpreter]{usage:interpret},
	...
	\begin{rationale} % A.6.1.0070 '
		...
		\replace{F94}{ANS Forth follows}{We follow} the usage of Forth 83.
...
\see \xref[3.4.1 Parsing]{usage:parsing},
	...
	\begin{rationale} % A.6.2.0855 C"
		...
		It is provided as an aid to porting existing 
		\place{F94}{pre Forth 94}
		programs
		\remove{F94}{to ANS Forth}
		systems. It is relatively difficult to implement \word{Cq}
