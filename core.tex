...
\item \stack{x_1 u}{x_2}
	...
	\begin{testing} % T.6.1.2162 RSHIFT
		...
		\test{8000 F \word{RSHIFT}}{1}					\tab[5.4] \word{bs} BIGGEST \\
		\test{ MSB 1 \word{RSHIFT} MSB \word{AND}}{  0} \word{bs} RSHIFT ZERO FILLS MSBS \\
...
\item \stack{"<spaces>name<space>"}{c-addr u}
	...
	\begin{testing} % T.6.2.---- PARSE-NAME
		...
		\tab[0.6] \word{NIP}}{0} \word{bs} empty line \\
		\test{PARSE-NAME    \\\mbox{}
		\tab[0.6] \word{NIP}}{0} \word{bs} line with white space
