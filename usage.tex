...
\place{ed11}{See \xref{rat:obsolet}}.
...
Most addresses used in \replace{F94}{ANS Forth}{Forth 94} are aligned addresses (indicated
...
\word{HOLD}, \word{HOLDS}, and \word[xchar]{XHOLD})  may also modify
...
(dot), \word{.R}, \word[tools]{.S}, \word[tools]{q}, \word[double]{D.},
\word[double]{D.R}, \word{Ud}, and \word{U.R} could also corrupt the
regions.
