...
\place{x:legacy}{%
	This standard removes the seven words that were marked `obsolescent'
	in the ANS Forth '94 document.  These are:}

\begin{tabular}{rl@{\qquad}rl@{\qquad}rl}
  \place{x:legacy}{   6.2.0060}	& \place{x:legacy}{\textbf{\#TIB}}
& \place{x:legacy}{15.6.2.1580}	& \place{x:legacy}{\textbf{FORGET}}
& \place{x:legacy}{   6.2.2240}	& \place{x:legacy}{\textbf{SPAN}} \\
  \place{x:legacy}{   6.2.0970}	& \place{x:legacy}{\textbf{CONVERT}}
& \place{x:legacy}{   6.2.2040}	& \place{x:legacy}{\textbf{QUERY}}
& \place{x:legacy}{   6.2.2290}	& \place{x:legacy}{\textbf{TIB}} \\
  \place{x:legacy}{   6.2.1390}	& \place{x:legacy}{\textbf{EXPECT}} \\
\end{tabular}
