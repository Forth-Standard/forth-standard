...
\begin{tabular}{rl@{\qquad}rl@{\qquad}rl}
	...
	\uline{6.2.0060}	& \uline{\textbf{\#TIB}}
&	\uline{6.2.1390}	& \uline{\textbf{EXPECT}}
&	\uline{6.2.2240}	& \uline{\textbf{SPAN}} \\
	\uline{6.2.0970}	& \uline{\textbf{CONVERT}}
&	\uline{6.2.2040}	& \uline{\textbf{QUERY}}
&	\uline{6.2.2290}	& \uline{\textbf{TIB}} \\
\end{tabular}
