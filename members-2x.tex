...
\remove{ed10}{Currently the committee has the following voting members:}
...
\place{ed10}{Currently the committee has the following voting members:}
...
\patch{ed10b}
\cbstart
\member{\sout{Federico de Ceballos}}
	{\sout{\texttt{federico.ceballos@unican.es}}}
	{\sout{Universidad de Cantabria}}
	{\sout{Santander, Spain}}
\cbend
