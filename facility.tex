...
\vspace*{-2ex}\enlargethispage{6ex}
...
\execute[name]
	...
	\walso{facility:CFIELD:}
	\walso{facility:FIELD:}
	\walso{floating:FFIELD:}
	\walso{floating:SFFIELD:}
	\walso{floating:DFFIELD:}
...
\note
	...
	\walso{facility:EKEY}
	\walso{facility:K-ALT-MASK}
	\walso{facility:K-CTRL-MASK}
	\walso{facility:K-DELETE}
	\walso{facility:K-DOWN}
	\walso{facility:K-END}
	\walso{facility:K-F1}
	\walso{facility:K-F10}
	\walso{facility:K-F11}
	\walso{facility:K-F12}
	\walso{facility:K-F2}
	\walso{facility:K-F3}
	\walso{facility:K-F4}
	\walso{facility:K-F5}
	...
	\walso{facility:K-F8}
	\walso{facility:K-F9}
	\walso{facility:K-HOME}
	\walso{facility:K-INSERT}
	\walso{facility:K-LEFT}
	\walso{facility:K-NEXT}
	\walso{facility:K-PRIOR}
	\walso{facility:K-RIGHT}
	\walso{facility:K-SHIFT-MASK}
	\walso{facility:K-UP}
