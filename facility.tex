...
%compile a data structure, with\linebreak \word{BEGIN-STRUCTURE}, and
%consumed at its close, with \word{END-STRUCTURE}, is represented by
%the symbol \param{struct-sys} throughout this Standard.}
