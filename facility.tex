...
\cbstart\patch{F12}
\subsection[Forth-\snapshot systems]{Forth-\snapshot\strike{-1}{25} systems} % 10.5.1
\cbend
...
\cbstart\patch{F12}
\subsection[Forth-\snapshot programs]{Forth-\snapshot\strike{-1}{25} programs} % 10.5.2
\cbend
...
\see \remove{ed12}{\rref{facility:AT-XY}{}.}
...
\see \rref{facility:KEYq}{}.
	...
	\begin{rationale} % A.10.6.1.1755 KEY?
		The \remove{ed12}{Technical} Committee has gone around several times on the
...
\execute[name]
\cbstart\patch{ed12}
	\stack{\sout{a-}addr_{\uline{1}}}{\sout{a}-addr_{\uline{2}}}
\cbend

	Add the \param{offset} calculated during the compile time action to
\cbstart\param{\sout{a-}addr_{\uline{1}}}\cbend\ 
	giving the character aligned address
\cbstart\param{\sout{c-}addr_{\uline{2}}}.\cbend
...
\execute[name]
\cbstart\patch{ed12}\stack{\sout{a-}addr_1}{\sout{a-}addr_2}\cbend

	Add the \param{offset} calculated during the compile time action
	to
\cbstart\param{\sout{a-}addr_1} giving the cell aligned address
\param{\sout{a-}addr_2}.\cbend
...
\cbstart\patch{ed12}
		\begin{tabbing}
			...
			\> \word{:} \word{FIELD:}   \>( n1 "name" -{}- n2 ; \sout{a-}addr1 -{}-  \sout{a-}addr2 )\> \word{ALIGNED}   \' 1 \word{CELLS}   \> \word{+FIELD} \word{;} \\
			\> \word{:} \word{CFIELD:}  \>( n1 "name" -{}- n2 ; \sout{a-}addr\uline{1}  -{}-  \sout{c-}addr\uline{2}   )\>                  \' 1 \word{CHARS}   \> \word{+FIELD} \word{;} \\
		\setwordlist{floating}
			\> \word{:} \word{FFIELD:}  \>( n1 "name" -{}- n2 ; \sout{a-}addr\uline{1} -{}-  \sout{f-}addr\uline{2} )\> \word{FALIGNED}  \' 1 \word{FLOATS}  \> \word[facility]{+FIELD} \word{;} \\
			\> \word{:} \word{SFFIELD:} \>( n1 "name" -{}- n2 ; \sout{a-}addr\uline{1} -{}- \sout{sf-}addr\uline{2} )\> \word{SFALIGNED} \' 1 \word{SFLOATS} \> \word[facility]{+FIELD} \word{;} \\
			\> \word{:} \word{DFFIELD:} \>( n1 "name" -{}- n2 ; \sout{a-}addr\uline{1} -{}- \sout{df-}addr\uline{2} )\> \word{DFALIGNED} \' 1 \word{DFLOATS} \> \word[facility]{+FIELD} \word{;}
