...
\begin{worddef}{0763}{BEGIN-STRUCTURE}
...
\begin{worddef}[EKEYtoFKEY]{1306}[40]{EKEY>FKEY}[e-key-to-f-key]
\item \stack{x}{u flag}
...
\begin{worddef}{1740}[06]{K-F1}[k-f-1]
\item \stack{}{u}
...
\begin{worddef}{1740}[11]{K-F3}[k-f-3]
\item \stack{}{u}
...
\begin{worddef}{1740}[16]{K-F8}[k-f-8]
\item \stack{}{u}
