...
\version{14.5}{Palma de Mallorca Meeting}{24--26 September 2014}
	The following changes where incorporated into the Forth 2012 standard
	document released on 10/Nov/2014.
	...
	\item[6] Core Word Set:						% core
		~\\ \textsf{ed14}: Added obsolescent notice to \wref{core:[COMPILE]}{}.
	\item[9] Exception Word Set:					% exception
...
\version{16.1}{Bath Meeting}{30 September -- 2 October 2015}
	...
	\item[A] Rationale (Annex \ref{annex:rationale}):				% rationale
		...
		\item \textsf{x:2-complement}: Revised example in \xref{rat:math:int}.
...
% Double
	...
	\item[D] Portability guide (Annex \ref{annex:port}):				% port
		\begin{enumerate}
		\item \textsf{x:2-complement}: Removed \xref{port:ALU}.
		\end{enumerate}
