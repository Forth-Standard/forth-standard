...
\makeatother
		...
		The return value \param{n} is
\place{ed14}{nonnegative}
\remove{ed14}{in the range \{0 {\ldots} +n\}}
		on success
		...
		As substitution is \replace{ed14}{non}{not} recursive, the return value could be used to
...
\item \stack{c-addr_1 u_1 c-addr_2}{c-addr_2 u_2}
	...
	\replace{ed14}{must}{ shall} be big enough to hold the unescaped string.  An ambiguous
