...
\item \stack{c-addr u_1}{c-addr u_2}
	...
	\begin{testing} % T.17.6.1.0170 -TRAILING
...
\item \stack{c-addr_1 u_1 n}{c-addr_2 u_2}
	...
	\begin{testing} % T.17.6.1.0245 /STRING
...
\item \stack{c-addr u}{}
	...
	\begin{testing} % T.17.6.1.0780 BLANK
		\ttfamily
...
\item \stack{c-addr_1 u_1 c-addr_2 u_2}{n}
	...
	\begin{testing} % T.17.6.1.0935 COMPARE
		\ttfamily
...
\item \stack{c-addr_1 u_1 c-addr_2 u_2}{c-addr_3 u_3 flag}
	...
	\begin{testing} % T.17.6.1.2191 SEARCH
...
\runtime
	...
	\begin{testing} % T.17.6.1.2212 SLITERAL
...
\item \stack{c-addr_1 u_1 c-addr_2 u_2}{}
	...
	\word{REPLACES} may allot data space and create a definition. 
	\replace{x:revise-replaces}{This breaks the contiguity of the current
	 region and is not allowed during compilation of a colon definition}{%
	Therefore \word{REPLACES} cannot be performed duing compilation
	of a colon definition or in the middle of a contiguous region}.

  
	\xalso{usage:contiguous}
	\xalso{usage:compilation}
	\walso{string:SUBSTITUTE}

	\begin{implement} % I.17.6.2.2141 REPLACES
		\word{DECIMAL}
...
\item \stack{c-addr_1 u_1 c-addr_2 u_2}{c-addr_2 u_3 n}
	...
	\walso{string:REPLACES}
	\walso{string:UNESCAPE}

	\begin{rationale} % A.17.6.2.2255 SUBSTITUTE
...
\makeatother
	...
	\begin{implement} % I.17.6.2.2255 SUBSTITUTE
...
%		\tab \word{OVER} \word{+} \word{SWAP} \word{qDO} \\
	...
	\begin{testing} % T.17.6.2.2255 SUBSTITUTE
		\ttfamily
...
\item \stack{c-addr_1 u_1 c-addr_2}{c-addr_2 u_2}
	...
	\begin{implement} % I.17.6.2.2375 UNESCAPE
	...
	\begin{testing} % T.17.6.2.2375 UNESCAPE
