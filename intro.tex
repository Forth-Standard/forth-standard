...
previously used words \place{X:fp-stack}{and practices} to become
...
\place{X:fp-stack}{This standard designates the following practice
(which has always been an environmental dependency) as obsolescent:
