...
some previously used words \place{X:fp-stack}{and practices}
...
\begin{itemize}
\item \place{X:fp-stack}{Requiring floating-point numbers to
	be kept on the data stack. (This has always been an
