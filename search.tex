...
\see \wref{search:WORDLIST}{},
	...
	\item[Typical use:]
		\word{VOCABULARY} Assembler

		To set search order to {\ldots} \word{FORTH} Assembler use: \\
		\word{ONLY} \word{FORTH} \word{ALSO} Assembler \word{DEFINITIONS}
	\end{rationale}
