...
\chapter{The Exception word set} % 9
...
% \subsection{Forth-\shapshot{} systems} % 9.5.1
...
\item \stack{i*x xt}{j*x 0 | i*x n}
	...
	\ralso{exception:THROW}

	\begin{implement} % I.9.6.1.0875 CATCH
	\dffamily
	...
	\begin{testing} % T.9.1.0875 CATCH
...
\item \stack{k*x n}{k*x | i*x n}
	...
	\begin{implement} % I.9.6.1.2275 THROW
	...
	\begin{testing} \ttfamily % T.9.6.1.2275 THROW
		\word{DECIMAL}
...
\item Extend the semantics of \wref{core:ABORT}{ABORT} to be:
	...
	\begin{implement} % I.9.6.1.0670 ABORT
		\word{:} \word{ABORT} ~ -1 \word{THROW} ~ \word{;}
	\end{implement}

	\begin{testing} % T.9.6.1.0670 ABORT
