...
and \word{TIB} contain information used by the Forth system in its
...
\texttt{BOB} \replace{ed09b}{in f) violates}{inviolate} the rule against declaring two sets of
locals.
% \replace[X:sttruct]{in f) violates}{inviolate}
