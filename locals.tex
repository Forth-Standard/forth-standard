...
\item[\uline{\emph{local} Interpretation}]
	\place{x:local-interpret}{Interpretation semantics for this word are undefined.}
...
\remove{x:local-interpret}{%
	An ambiguous condition exists when \param{name} is executed while
	in interpretation state.}

\item[\uline{\emph{name} Interpretation}]
	\place{x:local-interpret}{Interpretation semantics of \param{name} are undefined.}
