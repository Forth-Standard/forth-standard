...
\marginpar{\tiny Text taken from \ref{float:notation} on page
	\pageref{float:notation} with minor changes.}
...
\textbf{E}) or rule names in angle brackets (e.g., \arg{decdigit});}
