...
\item[\uline{initiation semantics:}]
\place{ed14}{%
...
\begin{itemize}
\item \sout{Each component of the element is defined with a rule consisting
...
\begin{table}[ht]
  \begin{center}
	...
	\uline{Extended-Character word set} & \cbstart\uline{XCHAR}\cbend \\
	\hline\hline
	\end{tabular}
  \end{center}
\end{table}
...
% ---------- X:number-prefix ----------
\cbstart\patch{ed14}
\subsection[BNF notation]{\uline{BNF notation}}
\label{notation:BNF}

\uline{The following notation is used to define the syntax of some
elements within the document:}
