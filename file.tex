...
\item \stack{c-addr u fam}{fileid ior}
	...
	\begin{testing} % T.11.6.1.1010 CREATE-FILE
		\ttfamily
...
\item \stack{c-addr u}{ior}
	...
	\begin{testing} % T.11.6.1.1190 DELETE-FILE
...
\item \stack{fileid}{ud ior}
	...
	\begin{testing} % T.11.6.1.1522 FILE-SIZE
		\ttfamily
...
\item \stack{}{fam}
	...
	\walso{file:CREATE-FILE}
	\walso{file:OPEN-FILE}
\end{worddef}
...
\vspace*{-7ex}\enlargethispage{8ex}
...
\item \stack{c-addr u_1 fileid}{u_2 flag ior}
	...
	\begin{testing} % T.11.6.1.2090 READ-LINE
		\ttfamily
...
\item \stack{ud fileid}{ior}
	...
	\begin{testing} % T.11.6.1.2142 REPOSITION-FILE
		\ttfamily
...
\item \stack{ud fileid}{ior}
	...
	\walso{file:READ-FILE}
	\walso{file:READ-LINE}

	\begin{testing} % T.11.6.1.2147 RESIZE-FILE
		\texttt{setpad} \\
...
\item \stack{}{0 | -1 | fileid}
	...
	\begin{testing} % T.11.6.1.2218 SOURCE-ID
...
\item \stack{c-addr u fileid}{ior}
	...
	\begin{testing} % T.11.6.1.2485 WRITE-LINE
		\ttfamily
...
\item \stack{i*x "name"}{j*x}
	...
	\walso{file:INCLUDED}{INCLUDED}

	\begin{rationale} % A.11.6.2.1714 INCLUDE
		Typical use:
		\begin{quote}
...
\item \stack{c-addr_1 u_1 c-addr_2 u_2}{ior}
	...
	\begin{testing} % T.11.6.2.2130 RENAME-FILE
		\ttfamily
...
\item \stack{i*x "name"}{i*x}
	...
	\begin{rationale} % A.11.6.2.2144.10 REQUIRE
		Typical use:
		\begin{quote}
	...
	\begin{implement} % I.11.6.2.2144.10 REQUIRE
		\word{:} \word{REQUIRE} \word{p} i*x "name" -{}- i*x ) \\
		\tab \word{PARSE-NAME} \word{REQUIRED} \word{;}
	\end{implement}

	\begin{testing} % T.11.6.2.2144.10 REQUIRE
		See \tref{file:REQUIRED}{REQUIRED}.
	\end{testing}
\end{worddef}
...
\item \stack{i*x c-addr u}{i*x}
	...
	\begin{rationale} % A.11.6.2.2144.50 REQUIRED
		Typical use:
		\begin{quote}
	...
	\begin{implement} % I.11.6.2.2144.50 REQUIRED
		\dffamily
	...
	\begin{testing} % T.11.6.2.2144.50 REQUIRED
