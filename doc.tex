...
\item \place{x:namelen}{using definition names of more than 31
	characters in length (\xref{usage:names});}

%\item \place{x:namelen}{using non graphic characters in a definition
%	name (\xref{usage:names});}
