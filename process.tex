\chapter*{\place{x:foreword}{Proposals Process}}
\label{process}
\addcontentsline{toc}{section}{\string\place{x:foreword}{Proposals Process}}
...
\item
	...
	Discussion) by sending a copy to the \texttt{forth200x@\replace{ed07}{yohoo}{yahoo}groups.com}
	email list \replace{ed07}{and}{\emph{and}} to the \texttt{comp.lang.forth} usenet news group
...
\item
	...
	consensus of those present at an \remove{ed07}{open} standards
	meeting. \place{ed07}{If you can not attend a meeting, you should
	ask somebody who is attending to champion the proposal on your
	behalf.}
\end{enumerate}
